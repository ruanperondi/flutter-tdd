...
import 'package:flutter_fordev/data/usecases/usecases.dart';
...
void main() {
  ...
  Map<String, dynamic> mockValidData = {'accessToken': accessToken, 'name': faker.person.name()};
  ...
  test('Should return an Account if HttpClient returns 200', () async {
    ...
    expect(accessToken, account.accessToken);
  });
